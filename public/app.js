...
$.getJSON("/articles", function(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    $("#articles").append(
      "<p data-id='" + data[i]._id + "' class='slug'>" + data[i].slug + "</p>" +
      "<p data-id='" + data[i]._id + "'><img src='" + data[i].imageSRC +
      "' alt='" + data[i].imageAlt + "' </img></p>" +
      "<p data-id='" + data[i]._id + "' class='title'>" + data[i].title + "</p>" + 
       "<a target='#' href='" + data[i].link + "'>Read on NPR</a></p><br><br>");
  }
});
